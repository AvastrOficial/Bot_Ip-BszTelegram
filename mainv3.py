...
# Token de tu bot
TOKEN = '7225315033:AAE0PMeQ257EPK-DIQUNhIEoC3y_bjZL-Vg'

# ID de chat (puedes definirlo si es necesario)
...
# Función para manejar el comando /start y mostrar un mensaje
async def start(update: Update, context: CallbackContext) -> None:
    # Definir el mensaje de bienvenida
    menu_text = "Aquí tienes algunos comandos que puedes usar:\n\n" \
                "/ip [dirección IP] - Sirve para geolocalizar una dirección IP"

    # Enviar el mensaje de bienvenida sin botones
